...
class BS_Users_Roles {
	...
	*/
	...
	public static function manipulate_roles() {
		$roles_to_add = apply_filters('bs_roles_to_add', static::$roles_to_add);
		$roles_to_remove = apply_filters('bs_roles_to_remove', static::$roles_to_remove);
		$capabilities_to_add = apply_filters('bs_capabilites_to_add', static::$capabilities_to_add);
		$capabilities_to_remove = apply_filters('bs_capabilites_to_remove', static::$capabilities_to_remove);
