...
class BS_Users_General {
	...
	public static function user_contactmethods($fields) {
		$remove = apply_filters('bs_user_contact_fields_to_remove', static::$contact_fields_to_remove);
		$add    = apply_filters('bs_user_contact_fields_to_add', static::$contact_fields_to_add);
	...
	public static function manage_users_columns($cols) {
		$remove = apply_filters('bs_user_columns_to_remove', static::$columns_to_remove);
