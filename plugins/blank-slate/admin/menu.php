...
//-----------------------------------------------------------------------------
	...
	public static function remove_menus() {
		$menu_pages_to_remove = apply_filters('bs_menu_pages_to_remove', static::$menu_pages_to_remove);
		$submenu_pages_to_remove = apply_filters('bs_submenu_pages_to_remove', static::$submenu_pages_to_remove);

		$admin_only_pages = apply_filters('bs_admin_only_pages', static::$admin_only_pages);
		$admin_only_subpages = apply_filters('bs_admin_only_subpages', static::$admin_only_subpages);
