...
abstract class BS_Dashboard_Widget {
	...
	public static function display() {
		...
		if (static::$fields) {
			echo '<form class="bs-dashboard-form" action="" method="POST">';
			wp_nonce_field(static::nonce(), static::nonce());
			BS_Meta_Box_Field_Factory::display_dashboard_fields(static::$fields);
			echo '<div class="bs-submit"><input name="save" type="submit" class="button button-primary button-large" value="Submit"/></div>';
			echo '</form>';
		}
	}
	...
	protected static function save() {
		...
		if (static::$fields) BS_Meta_Box_Field_Factory::save_dashboard_fields(static::$fields);
	}

	public static function add_dashboard_widget() {
		if (!(static::$id && static::$title)) {
			trigger_error('$id, $title must be defined on BS_Dashboard_Meta_Box subclasses.');
			return;
		}
	...
	protected static function show_widget() {
		return apply_filters('bs_show_dashboard_widget', static::$show_widget, static::$id);
	}
