...
class BS_Right_Now_Widget extends BS_Dashboard_Widget {

	protected static $id = 'bs-right-now';
	...
	public static function display() {
		?>
			<div id="bs-right-now-container" style="display:none;"></div>
			<p id="bs-right-now-loading" class="empty">Loading...</p>
			<script>jQuery(function($){$('#bs-right-now').bs_right_now();});</script>
		<?php
	}
	...
	protected static function show_widget() {
		...
		return get_option('bs-right-now-enabled', true);
	}
